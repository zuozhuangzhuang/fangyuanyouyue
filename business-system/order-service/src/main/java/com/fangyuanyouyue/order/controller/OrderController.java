...
import com.fangyuanyouyue.order.client.BaseController;
...
import com.fangyuanyouyue.order.utils.ReCode;
import com.fangyuanyouyue.order.utils.ResultUtil;
...
public class OrderController extends BaseController{
    ...
    @ResponseBody
    public String saveOrder(OrderParam param) throws IOException {
        try {
            log.info("----》商品下单《----");
            ...
            return toSuccess(orderDto,"商品下单成功！");
        } catch (Exception e) {
            e.printStackTrace();
    ...
    @ResponseBody
    public String cancelOrder(OrderParam param) throws IOException {
        try {
            log.info("----》取消订单《----");
            log.info("参数："+param.toString());
            //参数判断
    ...
    @ResponseBody
    public String orderDetail(OrderParam param) throws IOException {
        try {
            log.info("----》订单详情《----");
            log.info("参数："+param.toString());
            //参数判断
    ...
    @ResponseBody
    public String myOrderList(OrderParam param) throws IOException {
        try {
            log.info("----》我的订单列表《----");
            log.info("参数："+param.toString());
            //验证用户
            ...
            return toSuccess(orderDtos,"获取我的订单列表成功！");
        } catch (Exception e) {
            e.printStackTrace();
            return toError("系统繁忙，请稍后再试！");
        }
