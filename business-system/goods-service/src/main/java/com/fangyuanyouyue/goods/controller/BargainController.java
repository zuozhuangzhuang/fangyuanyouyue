...
public class BargainController extends BaseController{
    ...
    @ResponseBody
    public String addBargain(GoodsParam param) throws IOException {
        try {
            log.info("----》商品压价申请《----");
    ...
    @ResponseBody
    public String updateBargain(GoodsParam param) throws IOException {
        try {
            log.info("----》处理压价《----");
            log.info("参数：" + param.toString());
            //验证用户
    ...
    @ResponseBody
    public String bargainList(GoodsParam param) throws IOException {
        try {
            log.info("----》我的压价列表《----");
            log.info("参数：" + param.toString());
            //验证用户
            ...
            return toSuccess( bargainDtos,"获取我的压价列表成功！");
        } catch (ServiceException e) {
            e.printStackTrace();
            return toError(e.getMessage());
        } catch (Exception e) {
