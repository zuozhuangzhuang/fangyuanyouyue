...
public class CommentController extends BaseController{
    ...
    @ResponseBody
    public String addComment(GoodsParam param) throws IOException {
        try {
            log.info("----》发布评论/回复《----");
    ...
    @ResponseBody
    public String commentLikes(GoodsParam param) throws IOException {
        try {
            log.info("----》评论点赞《----");
            log.info("参数："+param.toString());
            //验证用户
    ...
    @ResponseBody
    public String getComments(GoodsParam param) throws IOException {
        try {
            log.info("----》查看全部评论《----");
            log.info("参数："+param.toString());
            if(param.getGoodsId() == null){
