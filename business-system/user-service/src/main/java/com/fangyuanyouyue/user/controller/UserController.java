...
//            if(!MD5Util.MD5(param.getLoginPwd()).equals(user.getLoginPwd())){
    ...
    public String addAddress(UserParam param) throws IOException {
        try {
            ...
            //TODO 添加收货地址
            List<UserAddressDto> userAddressDtos = userAddressInfoService.addAddress(param.getUserId(),param.getReceiverName(),param.getReceiverPhone(),param.getProvince(),param.getCity(),param.getArea(),param.getAddress(),param.getPostCode(),param.getType());
    ...
    public String deleteAddress(UserParam param) throws IOException {
        try {
            ...
            //TODO 删除收货地址
            List<UserAddressDto> userAddressDtos = userAddressInfoService.deleteAddress(param.getUserId(),param.getAddressId());
...
//            return toError(e.getMessage());
    ...
    public String updatePhone(UserParam param) throws IOException {
        try {
            ...
            //TODO 修改绑定手机
            UserDto userDto = userInfoService.updatePhone(param.getUserId(),param.getPhone());
    ...
    public String accountMerge(UserParam param) throws IOException{
        try {
            ...
            //TODO 合并账号
            UserDto userDto = userInfoService.accountMerge(param.getUserId(),param.getPhone());
            return toSuccess(userDto,"修改绑定手机成功！");
        } catch (ServiceException e) {
            e.printStackTrace();
            return toError(e.getMessage());
